...
async def gpt_time_out(bot, mei_response_string, message_obj):
    prompt = [
        {"role": "system",
         "content": "You are now a robot that is only capable of outputing numbers. on a scale of 1 to 10 from not annoyed to about to burst from annoyance, how annoyed do you think is Mei?."},
